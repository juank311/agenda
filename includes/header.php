        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">                  
                    ...
                    <a class="btn btn-dark" href="contactos.php" id="btn_contactos"  name="btn_contactos " role="button"  aria-expanded="false">CONTACTOS</a>
                    
                    <a class="btn btn-dark" href="categorias.php" id="btn_categorias" ame="btn_categorias" role="button"  aria-expanded="false">CATEGORIAS</a>               
                </ul>     
            </div>
        </div>
    </nav>
